...
def main():
    ...
    even_better_draw_circles(rg.Point(100,50),15,11,'red', 3)
    even_better_draw_circles(rg.Point(-200,0),5,30,'blue',4)
...
def better_draw_circles(point, radiiincrease):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.right(90)
        turtle.forward(radiiincrease)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radiiincrease * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, radiiincrease, number_of_circles, pencolor, penthick):
    ...
    turtle.pen = rg.Pen(pencolor, penthick)
